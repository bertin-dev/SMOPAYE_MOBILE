...
import static com.ezpass.smopaye_mobile.ChaineConnexion.getAdresseURLGoogleAPI;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //finish();
                startActivity(new Intent (MessageActivity.this, HomeAssistanceOnline.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
            }
        });*/
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(user.getImageURL().equals("default")){
                    profile_image.setImageResource(R.drawable.ic_user_google_blank);
                }
                else
                {
                    //Change this
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    Data data = new Data(fuser.getUid(), R.mipmap.ic_launcher, username + ": " + message, title, userid, statut_notif);
