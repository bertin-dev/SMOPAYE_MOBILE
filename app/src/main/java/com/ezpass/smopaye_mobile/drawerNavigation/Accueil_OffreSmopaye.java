package com.ezpass.smopaye_mobile.drawerNavigation;
...
//check current state of a check box (true or false)
       ...
       /* prefManager = new PrefManager(this);
        ...
        setContentView(R.layout.activity_accueil__offre_smopaye);
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(Accueil_OffreSmopaye.this, Login.class));
        finish();
    }
