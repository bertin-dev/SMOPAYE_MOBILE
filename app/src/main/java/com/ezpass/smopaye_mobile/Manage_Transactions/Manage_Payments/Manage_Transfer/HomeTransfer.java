...
public class HomeTransfer extends AppCompatActivity {

    private static final String TAG = "HomeTransfer";
    private TabLayout tabLayout;
    private int[] tabIcons = {
            R.drawable.ic_transfert_24,
            R.drawable.ic_baculer_account_24};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProgressDialog progressDialog = new ProgressDialog(HomeTransfer.this);
    ...
    private void addTabs(ViewPager viewPager) {
        ...
        adapter.addFrag(new FragmentTransfer(), getString(R.string.transfert));
        adapter.addFrag(new FragmentToggleUnitDeposit(), getString(R.string.basculer));
