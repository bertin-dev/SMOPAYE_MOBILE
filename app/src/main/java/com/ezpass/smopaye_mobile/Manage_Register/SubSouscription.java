...
public class SubSouscription extends AppCompatActivity
    ...
    protected void onStart() {
        ...
        if(!(activeInfo != null && activeInfo.isConnected())){
            ...
            Toast.makeText(SubSouscription.this, getString(R.string.pasDeConnexionInternet), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onPostCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(tokenManager.getToken() == null){
            startActivity(new Intent(SubSouscription.this, Login.class));
            finish();
        }
        ...
        call2.enqueue(new Callback<List<Categorie>>() {
            ...
            public void onFailure(Call<List<Categorie>> call, Throwable t) {
                ...
                //Vérification si le serveur est inaccessible
                    ...
                    Toast.makeText(SubSouscription.this, getString(R.string.connexionLimite), Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(SubSouscription.this);
        build_error = new AlertDialog.Builder(SubSouscription.this);
                ...
                switch (msg.what) {
                    ...
                    case SHOW_NFC_DATA: {
                        ...
                        if (uid_data[0] == 0x42) {
                            ...
                            new AlertDialog.Builder(SubSouscription.this)
    ...
    private void changeActivity() {
        ...
        if(activeInfo != null && activeInfo.isConnected()){
            ...
            authWindows.setVisibility(View.GONE);
            internetIndisponible.setVisibility(View.VISIBLE);
            Toast.makeText(SubSouscription.this, getString(R.string.connexionIntrouvable), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    void register(){
        ...
        if(validator.validate()){
            //********************DEBUT***********
            dialog2 = new ACProgressPie.Builder(SubSouscription.this)
    ...
    private void registerSubAccountDataInSmopayeServer(String nom1, String prenom1, String sexe1, String telephone1, String typePJ1,
            ...
            public void onResponse(Call<AllMyResponse> call, Response<AllMyResponse> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    if(response.code() == 422){
                        ...
                        Toast.makeText(SubSouscription.this, apiError.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private class AsyncTaskRegisterDataInGoogleFirebaseServer extends AsyncTask<Void,Void,String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            progressDialogGoogle = ProgressDialog.show(SubSouscription.this, getString(R.string.etape2EnvoiDesDonnees), getString(R.string.connexionServeurSmopaye),true,true);
                        ...
                        if(task.isSuccessful()){
                            ...
                            reference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    Toast.makeText(SubSouscription.this, getString(R.string.operationReussie), Toast.LENGTH_SHORT).show();
                                            ...
                                            if(dataSnapshot.exists()){
                                                for (DataSnapshot userSnapshot : dataSnapshot.getChildren()) {
                                                    ...
                                                    if (user.getId_carte().equals(id_carte1)) {
                                                        ...
                                                        Toast.makeText(SubSouscription.this, getString(R.string.numCompteExistPas), Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                            }
                                            else{
                                                Toast.makeText(SubSouscription.this, getString(R.string.impossibleSendNotification), Toast.LENGTH_SHORT).show();
                                            }
                            ...
                            Toast.makeText(SubSouscription.this, getString(R.string.impossibleRegister), Toast.LENGTH_SHORT).show();
                            View view = LayoutInflater.from(SubSouscription.this).inflate(R.layout.alert_dialog_success, null);
                            TextView title = (TextView) view.findViewById(R.id.title);
                            TextView statutOperation = (TextView) view.findViewById(R.id.statutOperation);
                            ImageButton imageButton = (ImageButton) view.findViewById(R.id.image);
                                ...
                                public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                                    if(response.code() == 200){
                                        if(response.body().success != 1){
                                            Toast.makeText(SubSouscription.this, getString(R.string.echoue), Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                }
