...
public class ProfileFragment extends Fragment {
    ...
    TextView username, telValeur, numCarteValeur;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        telValeur = view.findViewById(R.id.telValeur);
        numCarteValeur = view.findViewById(R.id.numCarteValeur);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(isAdded()) {
                    ...
                    telValeur.setText(user.getTel());
                    numCarteValeur.setText(user.getId_carte());
                    if (user.getImageURL().equals("default")) {
                        image_profile.setImageResource(R.drawable.ic_account_circle_black_48dp);
                    } else {
