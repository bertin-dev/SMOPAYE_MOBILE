...
public class EditProfil extends AppCompatActivity
        ...
        call2.enqueue(new Callback<List<Categorie>>() {
            ...
            public void onFailure(Call<List<Categorie>> call, Throwable t) {
                ...
                //Vérification si le serveur est inaccessible
                    ...
                    Toast.makeText(EditProfil.this, getString(R.string.connexionLimite), Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tie_nom.setText(nom);
        tie_prenom.setText(prenom);
        tie_numeroTel.setText(numeroTel);
        tie_cni.setText(cni);
        tie_adresse.setText(adresse);
        tie_numCarte.setText(numero_card);
    ...
    private void changeActivity() {
        ...
        if(activeInfo != null && activeInfo.isConnected()){
            ...
            authWindows.setVisibility(View.GONE);
            internetIndisponible.setVisibility(View.VISIBLE);
            Toast.makeText(EditProfil.this, getString(R.string.connexionIntrouvable), Toast.LENGTH_SHORT).show();
        }
    }
...
/*****************************************************SENDER MESSAGE******************************/
        ...
        LocalNotification(getString(R.string.editProfil), msgSender);
    ...
    private class AsyncTaskRegisterDataInGoogleFirebaseServer extends AsyncTask<Void,Void,String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            progressDialogGoogle = ProgressDialog.show(EditProfil.this, getString(R.string.etape2EnvoiDesDonnees), getString(R.string.connexionServeurSmopaye),true,true);
                        ...
                        if(task.isSuccessful()){
                            ...
                            reference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    Toast.makeText(EditProfil.this, getString(R.string.operationReussie), Toast.LENGTH_SHORT).show();
                                            ...
                                            if(dataSnapshot.exists()){
                                                for (DataSnapshot userSnapshot : dataSnapshot.getChildren()) {
                                                    ...
                                                    if (user.getId_carte().equals(id_carte1)) {
                                                        RemoteNotification(user.getId(), user.getPrenom(), getString(R.string.editProfil), response1, "success");
                                                        //Toast.makeText(RetraitAccepteur.this, "CARTE TROUVE", Toast.LENGTH_SHORT).show();
                                                    } else {
                                                        Toast.makeText(EditProfil.this, getString(R.string.numCompteExistPas), Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                            }
                                            else{
                                    ...
                                    //////////////////////////////////NOTIFICATIONS////////////////////////////////
                                    LocalNotification(getString(R.string.editProfil), response1);
                                    dbHandler.insertUserDetails(getString(R.string.editProfil), response1, "0", R.drawable.ic_notifications_black_48dp, shortDateFormat.format(aujourdhui));
                                    ...
                                    build_error.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            Intent intent = new Intent(EditProfil.this, QRCodeShow.class);
                            ...
                            //////////////////////////////////NOTIFICATIONS////////////////////////////////
                            LocalNotification(getString(R.string.editProfil), getString(R.string.impossibleRegister));
                            dbHandler.insertUserDetails(getString(R.string.editProfil),getString(R.string.impossibleRegister), "0", R.drawable.ic_notifications_red_48dp, shortDateFormat.format(aujourdhui));

                            Toast.makeText(EditProfil.this, getString(R.string.impossibleRegister), Toast.LENGTH_SHORT).show();
                            View view = LayoutInflater.from(EditProfil.this).inflate(R.layout.alert_dialog_success, null);
                            TextView title = (TextView) view.findViewById(R.id.title);
                            TextView statutOperation = (TextView) view.findViewById(R.id.statutOperation);
                            ImageButton imageButton = (ImageButton) view.findViewById(R.id.image);
