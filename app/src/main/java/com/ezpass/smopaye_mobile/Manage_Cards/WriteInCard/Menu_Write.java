...
public class Menu_Write extends AppCompatActivity {
    ...
    private void changeColorWidget() {
        if(Constant.color == getResources().getColor(R.color.colorPrimaryRed)){
            ...
            //Button
            BtnInfo.setBackground(ContextCompat.getDrawable(this, R.drawable.btn_rounded_red));
            reset.setBackground(ContextCompat.getDrawable(this, R.drawable.btn_rounded_red));
            write.setBackground(ContextCompat.getDrawable(this, R.drawable.btn_rounded_red));
